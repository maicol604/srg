...
const consumerKey = 'ck_2b8713dd16d5ebe0605bcd5354d87ddba483d8db';
const consumerSecret = 'cs_c8821baae97c810c446c958f94c3f593f88654dc';
...
export default {
  ...
  intro: [
    {
      key: 'page1',
      title: 'Confirma que eres mayor de 18 años para acceder a la aplicación',
      text: '',
      icon: false,
